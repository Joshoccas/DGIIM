...
${OBJECTDIR}/_ext/32002bda/gtest-all.o: ../googletest-master/googletest/src/gtest-all.cc
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../googletest-master/googletest/include -I../googletest-master/googletest -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/32002bda/gtest-all.o ../googletest-master/googletest/src/gtest-all.cc

${OBJECTDIR}/_ext/32002bda/gtest_main.o: ../googletest-master/googletest/src/gtest_main.cc
	${MKDIR} -p ${OBJECTDIR}/_ext/32002bda
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../googletest-master/googletest/include -I../googletest-master/googletest -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/32002bda/gtest_main.o ../googletest-master/googletest/src/gtest_main.cc
