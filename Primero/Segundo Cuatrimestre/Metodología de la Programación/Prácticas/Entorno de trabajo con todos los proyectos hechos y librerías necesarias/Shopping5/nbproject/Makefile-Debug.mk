...
${OBJECTDIR}/src/Index.o: src/Index.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../MPTest/include -I../googletest-master/googletest/include -Iinclude -Iinclude -I../AnsiTerminal/include -I../DataTable/include -Isrc -include include/DateTime.h -include include/Event.h -include include/EventSet.h -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Index.o src/Index.cpp

${OBJECTDIR}/src/Matrix.o: src/Matrix.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../MPTest/include -I../googletest-master/googletest/include -Iinclude -Iinclude -I../AnsiTerminal/include -I../DataTable/include -Isrc -include include/DateTime.h -include include/Event.h -include include/EventSet.h -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Matrix.o src/Matrix.cpp

${OBJECTDIR}/src/Pair.o: src/Pair.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../MPTest/include -I../googletest-master/googletest/include -Iinclude -Iinclude -I../AnsiTerminal/include -I../DataTable/include -Isrc -include include/DateTime.h -include include/Event.h -include include/EventSet.h -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Pair.o src/Pair.cpp
...
${TESTDIR}/tests/04.UnitPair.o: tests/04.UnitPair.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -D__INTEGRATION__ -I../MPTest/include -I../googletest-master/googletest/include -Iinclude -Iinclude -I../AnsiTerminal/include -I../DataTable/include -I. -include include/DateTime.h -include include/Event.h -include include/EventSet.h -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/04.UnitPair.o tests/04.UnitPair.cpp


${TESTDIR}/tests/05.UnitIndex.o: tests/05.UnitIndex.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -D__INTEGRATION__ -I../MPTest/include -I../googletest-master/googletest/include -Iinclude -Iinclude -I../AnsiTerminal/include -I../DataTable/include -I. -include include/DateTime.h -include include/Event.h -include include/EventSet.h -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/05.UnitIndex.o tests/05.UnitIndex.cpp


${TESTDIR}/tests/06.UnitMatrix.o: tests/06.UnitMatrix.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -D__INTEGRATION__ -I../MPTest/include -I../googletest-master/googletest/include -Iinclude -Iinclude -I../AnsiTerminal/include -I../DataTable/include -I. -include include/DateTime.h -include include/Event.h -include include/EventSet.h -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/06.UnitMatrix.o tests/06.UnitMatrix.cpp


${TESTDIR}/tests/10.Integration.o: tests/10.Integration.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -D__INTEGRATION__ -I../MPTest/include -I../googletest-master/googletest/include -Iinclude -Iinclude -I../AnsiTerminal/include -I../DataTable/include -I. -include include/DateTime.h -include include/Event.h -include include/EventSet.h -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/10.Integration.o tests/10.Integration.cpp
...
${OBJECTDIR}/src/Index_nomain.o: ${OBJECTDIR}/src/Index.o src/Index.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I../MPTest/include -I../googletest-master/googletest/include -Iinclude -Iinclude -I../AnsiTerminal/include -I../DataTable/include -Isrc -include include/DateTime.h -include include/Event.h -include include/EventSet.h -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Index_nomain.o src/Index.cpp;\
	else  \
...
${OBJECTDIR}/src/Matrix_nomain.o: ${OBJECTDIR}/src/Matrix.o src/Matrix.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I../MPTest/include -I../googletest-master/googletest/include -Iinclude -Iinclude -I../AnsiTerminal/include -I../DataTable/include -Isrc -include include/DateTime.h -include include/Event.h -include include/EventSet.h -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Matrix_nomain.o src/Matrix.cpp;\
	else  \
...
${OBJECTDIR}/src/Pair_nomain.o: ${OBJECTDIR}/src/Pair.o src/Pair.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I../MPTest/include -I../googletest-master/googletest/include -Iinclude -Iinclude -I../AnsiTerminal/include -I../DataTable/include -Isrc -include include/DateTime.h -include include/Event.h -include include/EventSet.h -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Pair_nomain.o src/Pair.cpp;\
	else  \
