...
${TESTDIR}/tests/10.Integration_WEEK_2.o: tests/10.Integration_WEEK_2.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -D__INTEGRATION__ -I../MPTest/include -I../googletest-master/googletest/include -Iinclude -Iinclude -I../AnsiTerminal/include -I../DataTable/include -I. -include include/DateTime.h -include include/Event.h -include include/EventSet.h -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/10.Integration_WEEK_2.o tests/10.Integration_WEEK_2.cpp


${TESTDIR}/tests/10.Integration_WEEK_3.o: tests/10.Integration_WEEK_3.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -D__INTEGRATION__ -I../MPTest/include -I../googletest-master/googletest/include -Iinclude -Iinclude -I../AnsiTerminal/include -I../DataTable/include -I. -include include/DateTime.h -include include/Event.h -include include/EventSet.h -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/10.Integration_WEEK_3.o tests/10.Integration_WEEK_3.cpp
