/**
 * 
 Código para multimplicación secuencial matriz cuadrada triangular superior por vector: v2 = m * v1 pmtv-paralelo.c
 * 
 */
 ...
 * **Compilación**
 * @code
	gcc  -O2  pmtv-paralelo.c -o pmtv-paralelo -lrt
    (-lrt: real time library, es posible que no sea necesario usar -lrt)
 * @endcode
* **Generar ensamblador**
 * @code
 * gcc  -O2 -S pmv-paralelo.c -lrt
 * @endcode
 *  **Ejecución**
 * ~~~~~~~~~~~~~~~~~~~~~{.c}
 * pmtv-paralelo 8    (para 8 componentes en los vectores)
 * ~~~~~~~~~~~~~~~~~~~~~
 * 
**/
